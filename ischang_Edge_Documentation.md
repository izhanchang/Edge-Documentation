...
2. Click on **Add this page to favorites** next to the address bar.
...
#### From the menu:
1. Select the **Settings and more** icon in the top right corner, then choose **Web capture**.
...
1. Select the **Settings and more** icon in the top right corner, then choose **Privacy, search, and services**.
...
1. Select the **Settings and more** icon in the top right corner, then choose **New Inprivate window**. 
...
2. Select the **Settings and more** icon in the top right corner, then choose **Read aloud**.
